...
if (isset($_POST['add_member'])) {
    ...
    $img_r=uploadImage($_FILES['picture'], ABOUT_FLODER);
    if ($img_r == 'inv_img') {
        echo $img_r;
        ...
        echo <<<data
            <div class="col-md-2 mb-3">
                <div class="card bg-dark text-white">
                    <img src="$path/$row[picture]" width="40px" height="200px" class="card-img" >
                    <div class="card-img-overlay text-end">
                        <button onclick="rem_member($row[sr_no])" class="btn btn-danger btn-sm shadow-none float-end" type="button">
...
if (isset($_POST['rem_member'])) {
    ...
    if (deleteImage($img['picture'], ABOUT_FLODER)) {
