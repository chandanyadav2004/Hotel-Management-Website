...
<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white ps-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php"><?php echo $setting_res['site_title'] ?></a>
      ...
      <form id="forgot-form">
        ...
        <div class="modal-body">
          ...
          <div class="text-end mb-2">
            <button type="button" class="btn shadow-none p-0 me-2" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#loginModal">Cancel</button>
            <button type="submit" class="btn btn-dark shadow-none ">Send Links</button>
          </div>
        </div>
      </form>
    </div>
